...
?>
<section class="page-order-review py-8 section-checkout section-py">
	<div class="container">
		<form id="order-review" method="post">
			<h2 class="title-line mb-5"><?= _e('Payment again','woocommerce') ?></h2>
			<div class="woocommerce-order-details mb-5">
							...
							<?php foreach ($order->get_items() as $item_id => $item) : ?>
								...
								<tr class="<?php echo esc_attr(apply_filters('woocommerce_order_item_class', 'order_item', $item, $order)); ?>">
									...
									<td class="product-quantity"><?php echo apply_filters('woocommerce_order_item_quantity_html', ' <strong class="product-quantity">' . sprintf('&times;&nbsp;%s', esc_html($item->get_quantity())) . '</strong>', $item); ?></td><?php // @codingStandardsIgnoreLine
																																																																	?>
									<td class="product-subtotal text-right"><?php echo $order->get_formatted_line_subtotal($item); ?></td><?php // @codingStandardsIgnoreLine
																																?>
								</tr>
							<?php endforeach; ?>
						<?php endif; ?>
			...
			<div id="payment">
				<h2 class="title-line mb-5"><?= _e('Payment method','woocommerce') ?></h2>
